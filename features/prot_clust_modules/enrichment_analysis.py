...
def run_enrichment_analysis(target_protein, pickle_path, output_dir, clust_algo_used=None):
    ...
    Parameters:
        ...
        clust_algo_used (str, optional): Name of the clustering algorithm used (e.g. 'louvain' or 'mcl').
                          This value will be appended to the output filename
                          resulting in `enrichment_cluster_{cluster_id}_{clust_algo_used}.csv`.
    ...
    try:
        ...
        # Determine output filename using cluster id + clustering algorithm tag
